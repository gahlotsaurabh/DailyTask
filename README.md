This app logs daily task in system and display the same in table format and also filter task based on the start date and use django rest framework for backend.
